package chatbot;
	...
	class KNN
	{
		...
		private static String findMajorityClass(String[] array)
		{
			...
			for (int i = 0; i < uniqueValues.length; i++)
				System.out.println("uniqueValues: "+uniqueValues[i]);
		...
		public static void main(String args[]){ 
			...
			cityList.add(new City(instances[1],"London"));
			cityList.add(new City(instances[2],"London"));
			cityList.add(new City(instances[3],"London"));
			cityList.add(new City(instances[4],"Liverpool"));
			cityList.add(new City(instances[5],"London London"));
			cityList.add(new City(instances[6],"London"));
			cityList.add(new City(instances[7],"London"));
			cityList.add(new City(instances[8],"London"));
