...
public class KTP {
	...
	/**
	 * The Description of this method is to find out in percent how much what you
	 * are looking for exists in a string ,"text" is the line of string to search in
	 * ,"search" is the letter to search for
	 * 
	 * @param the
	 *            parameters used by this method.
	 * @return the value returned by this method is the number in percent of how
	 *         much what you are looking for exists in the text, if returns from 0
	 *         to 100 depends how the percent, It will also return 0 if you pass a
	 *         null value
	 */
	...
	/**
	 * The Description of this method is to find out how many a letter exists in a
	 * string ,"text" is the line of string to search in ,"letter" is the letter to
	 * search for
	 * 
	 * @param the
	 *            parameters used by this method.
	 * @return the value returned by this method is the number of how many a letter
	 *         exist in the text, if returns 0 it means there is no such letter in
	 *         the text, It will also return 0 if you pass a null value
	 */
	...
	/**
	 * The Description of this method is to find out how many a word exists in a
	 * string ,"text" is the line of string to search in ,"word" is the word to
	 * search for
	 * 
	 * @param the
	 *            parameters used by this method.
	 * @return the value returned by this method is the number of how many a word
	 *         exist in the text, if returns 0 it means there is no such letter in
	 *         the text, It will also return 0 if you pass a null value
	 */
	 ...
	 * @param the
	 *            parameters used by this method.
	 * @return the value returned by this method is either true or false, It will
	 *         also return false if you pass a null value
	 */
	...
	/**
	 * The Description of this method is to replace as much as you want in a string,
	 * "text" is the text to replace in,"word" is to find and replace, "replacement"
	 * is what to replace "word" with in "text", "number" is how many existing
	 * similarities you want to replace
	 * 
	 * @param the
	 *            parameters used by this method.
	 * @return the value returned by this method is the string after making the
	 *         replace changes, It will also return null if you pass a null value
	 */
	...
	/**
	 * The Description of this method is to crop a part of a string from long
	 * string, "text" is the text to crop from,"from" is the start point, "to" is
	 * the end point "leavesides" is a boolean value if it is false then it will
	 * crop without sides else it will crop with sides
	 * 
	 * @param the
	 *            parameters used by this method.
	 * @return the value returned by this method is the cropped part of the string
	 *         after from the start point till end point, It will also return null
	 *         if you pass a null value
	 */
	...
	/**
	 * The Description of this method is to remove any digit from a string, "text"
	 * is the text to remove digits from.
	 * 
	 * @param the
	 *            parameters used by this method.
	 * @return the value returned by this method is the string after removing the
	 *         digits from, It will also return null if you pass a null value
	 */
	...
	/**
	 * The Description of this method is to remove every word in string based on a
	 * String[], "text" is the text to remove words from, search is the String[]
	 * containing the words
	 * 
	 * @param the
	 *            parameters used by this method.
	 * @return the value returned by this method is the string after removing the
	 *         words from, It will also return null if you pass a null value
	 */
	...
	/**
	 * The Description of this method is to replace every word in string based on a
	 * String[] which is "search" with "replacement", "text" is the text to remove
	 * words from, "search" is the String[] containing the words,"replacement" is
	 * the word to replace with
	 * 
	 * @param the
	 *            parameters used by this method.
	 * @return the value returned by this method is the string after replacing the
	 *         words from, It will also return null if you pass a null value
	 */
	...
	/**
	 * The Description of this method is to convert every word in string to
	 * ArrayList, "text" is the text to convert words from.
	 * 
	 * @param the
	 *            parameters used by this method.
	 * @return the value returned by this method is the list after adding each word
	 *         to, It will also return null if you pass a null value
	 */
	...
	public int getHammingDistance2(String sequence1, String sequence2) {
